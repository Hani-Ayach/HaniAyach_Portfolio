          ...
          <div className="col-lg-6 text-center">
            ...
            <div className="d-flex flex-wrap justify-content-center gap-4">
              <SkillItem
                ...
                label=".NET Stack"
              />
              <SkillItem icon={<FaReact color="#61DBFB" />} label="React" />
              <SkillItem icon={<FaAngular color="#dd1b16" />} label="Angular" />
              <SkillItem icon={<FaVuejs color="#42b883" />} label="Vue.js" />
              <SkillItem icon={<FaNodeJs color="#3C873A" />} label="Node.js" />
              <SkillItem
                icon={<FaDatabase color="#f9c74f" />}
                label="Databases"
              />
              <SkillItem
                icon={<FaCogs color="#adb5bd" />}
                label="Design Patterns"
              />
              <SkillItem icon={<FaCode color="#6c757d" />} label="REST APIs" />
              <SkillItem
                icon={<FaLaptopCode color="#17a2b8" />}
                label="Full-Stack"
              />
            </div>
          </div>
